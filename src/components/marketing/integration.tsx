...
const SOCIAL_PLATFORMS = [
    { 
        ...
        iconSize: "large", 
        className: "flex",
        link: "https://www.linkedin.com/company/7gence/"
    },
    { 
        icon: Icons.facebook, 
        position: "right-1", 
        ...
        <div className="relative flex flex-col items-center justify-center w-full py-10">
            <Container className="relative">
                <div className="relative flex flex-col lg:hidden items-center justify-center overflow-visible">
                    ...
                    {/* Mobile Logo and Social Icons Layout */}
                    <div className="relative flex h-64 w-full flex-col items-center justify-center overflow-visible">
                        <div className="absolute z-20 flex items-center justify-center group">
                            <Images.logo className="size-16 group-hover:scale-110 transition-all duration-500" />
                        </div>
                        ...
                        {SOCIAL_PLATFORMS.map((platform, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className={cn(
                                        "absolute z-20 size-12 p-2 rounded-full flex items-center justify-center bg-gradient-to-b from-foreground/5 to-transparent shadow-xl shadow-black/10 backdrop-blur-lg transition-all duration-300 hover:scale-110",
                                        index === 0 ? "-translate-x-16" : "translate-x-16"
                                    )}
                                >
                                    {platform.link ? (
                                        <a 
            ...
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto lg:absolute lg:top-1/4 inset-x-0 mt-12 lg:mt-0">
                <h2 className="text-2xl md:text-4xl lg:text-6xl font-heading font-semibold !leading-snug">
                    Follow the build.<br />
                    <span className="text-muted-foreground text-2xl md:text-3xl lg:text-4xl font-normal">We share what we&apos;re working on.</span>
                </h2>
            </div>
