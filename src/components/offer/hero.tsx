    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            ...
            <div className="flex flex-col items-center justify-center gap-y-8 relative">
                <Container className="hidden lg:flex absolute inset-0 flex-col items-center justify-center w-full -z-10">
                    ...
                    <Container className="relative hidden lg:block overflow-hidden">
                        <button className="group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center">
                                ...
                                For Real Estate Agents &amp; Brokers — India &amp; UAE
                            </span>
                        </button>
                    </Container>
                    <Container delay={0.15}>
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-center !leading-tight max-w-4xl mx-auto px-4 md:px-0">
                            Fill Your Pipeline With Buyers and Sellers Who Are Actually Ready to Close
                        </h1>
                    </Container>
                    <Container delay={0.2}>
                        <p className="max-w-xl mx-auto mt-2 text-sm sm:text-base lg:text-lg text-center text-muted-foreground px-4 md:px-0">
                            We run targeted ads, then qualify every lead with AI before it reaches you — so you spend your time closing deals, not chasing tire-kickers.
                        </p>
                    </Container>
